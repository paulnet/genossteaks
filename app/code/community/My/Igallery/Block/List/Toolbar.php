 ...
 * @category    My
 * @package     My_Igallery
 * @copyright   Copyright (c) 2011 Magento-Service. (http://www.magentoservice.com)
 ...
 */
class My_Igallery_Block_List_Toolbar extends Mage_Core_Block_Template
{
    /**
     * Products collection
     *
    ...
    protected function _construct()
    {
        ...
        $this->setTemplate('my_igallery/list/toolbar.phtml');
    }
    ...
    {
        return (int)Mage::getStoreConfig('igallery/image_limit');
    }
    ...
    protected function _getAvailableLimit($mode)
    {
        ...
        $perPageConfigKey = 'igallery/general/allowed_limit_values';
        $perPageValues = (string)Mage::getStoreConfig($perPageConfigKey);
        $perPageValues = explode(',', $perPageValues);
        $perPageValues = array_combine($perPageValues, $perPageValues);
        if (Mage::getStoreConfigFlag('igallery/general/list_allow_all')) {
    ...
    {
        $pagerBlock = $this->getLayout()->createBlock('igallery/html_pager');
